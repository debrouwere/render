...
(function() {
  var PathExp, add, async, base, consolidate, content, context, contexts, data, extension, fs, groups, isCollection, layoutTemplate, location, name, outputTemplate, path, program, render, segments, trace, uniquelyIdentifies, wrap, _, _i, _len, _ref;
